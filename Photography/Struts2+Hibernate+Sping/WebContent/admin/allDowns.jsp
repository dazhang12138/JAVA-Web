        ...
        <div class="container-fluid paper-wrap bevel tlbr">
          ...
          <!--   / TITLE
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">记录管理</a>
                </li>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li><a href="#" title="Sample page 1">查看所有记录</a>
                </li>
                <li class="pull-right">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="nest" id="tableStaticClose">
                            <div class="title-alt">
                                <h6>所有记录列表 : <span style="color: red;">${result }</span></h6>
                            ...
                            <div class="body-nest" id="tableStatic">
                                ...
                                <section id="flip-scroll">
                                    ...
                                    <table class="table table-bordered table-striped cf" id="devCompanyInfos">
                                        <thead class="cf">
                                            <tr>
                                                <th class="numeric">记录编号</th>
                                                <th class="numeric">用户编号</th>
                                                <th class="numeric">图片编号</th>
                                                <th class="numeric">记录时间</th>
                                                <th class="numeric">记录事件</th>
                                                <th class="numeric">积分更改</th>
                                            </tr>
                                        </thead>
                                        <tbody >
