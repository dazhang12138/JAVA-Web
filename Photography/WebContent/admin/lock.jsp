...
<body id="lock">
    ...
    <section class="page-error">
        ...
        <!-- /.headline -->
        <div class="lockscreen-name">${user.uname }</div>
        <div class="lockscreen-image">
            <img src="<%=basePath %>./image/1~1.jpg" alt="user image" />
        </div>
        <!-- User name -->
        ...
        <div class="lockscreen-link">
            <a class="lock-link" href="<%=basePath %>./index.jsp">如果您不是管理员请离开</a>
        </div>
		<div><button onclick="books()">
			</button> 
		</div>
    </section>
    <!--  END OF PAPER WRAP -->
