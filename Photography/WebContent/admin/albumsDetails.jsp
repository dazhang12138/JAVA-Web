        ...
        <div class="container-fluid paper-wrap bevel tlbr">
          ...
          <!--   / TITLE
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">专辑详情</a>
                </li>
                <li class="pull-right">
          ...
          <div  style="margin-top: 10px; float: left; width: 100%">
             <div style="margin-left: 40px ;float: left; width: 10%" >
          	 <button class="btn btn-info" onclick="window.history.back();" >返回</button>
              </div>
              <div  style="width: 90%;">
             <div class="progress-demo" align="center">
             <a href="<%=basePath %>QueryAlbumsPicture?id=${album.a_id}" class="ladda-button" data-color="mint" data-style="expand-right" data-size="xs">刷新列表</a>
                            ...
                            <div class="body-nest" id="tableStatic">
                                ...
                                <section id="flip-scroll">
                                    ...
                                    <table class="table table-bordered table-striped cf" id="devCompanyInfos">
                                        <thead class="cf">
                                            <tr >
                                                ...
                                                <th class="numeric">图片编号</th>
                                                <th class="numeric">图片名称</th>
                                                <th class="numeric">拍摄时间</th>
                                                <th class="numeric">下载积分</th>
                                                <th class="numeric" style="max-width: 700px;">介绍</th>
                                    ...
                                    <span class="entypo-pencil"></span>&nbsp;&nbsp;修改</a>
                                                <a type="button" class="btn btn-info"  href="<%= basePath%>DeletePicture?pid=${p.p_id}&id=${album.a_id}"  onclick="return confirm('是否删除 : '+'${p.p_name }' + '\n操作不可逆，请谨慎操作')" >
