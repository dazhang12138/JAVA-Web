		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					<!-- Start Sign In Form -->
					<form action="<%=basePath %>Register" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						<h2>注册</h2>
						<div class="form-group">
							<div class="alert alert-success" role="alert">请认真填写注册信息.</div>
						</div>
						<div class="form-group">
							<input name="name" type="text" class="form-control" id="name" placeholder="姓名" autocomplete="off" onblur="DetecName()">
							<span style="color: red;" id="dname"></span>
						</div>
						<div class="form-group">
							<input name="uname" type="text" class="form-control" id="uname" placeholder="用户名" autocomplete="off" onblur="DetecUName()">
							<span style="color: red;" id="duname"></span>
						</div>
						<div class="form-group">
							<input name="pwd" type="password" class="form-control" id="password" placeholder="密码" autocomplete="off" onblur="DetecPwd()">
							<span style="color: red;" id="dpwd"></span>
						</div>
						<div class="form-group">
							<input name="phone" type="text" class="form-control" id="phone" placeholder="手机号" autocomplete="off" onblur="DetecPhone()">
							<span style="color: red;" id="dphone"></span>
						</div>
						<div class="form-group">
							<input name="email" type="email" class="form-control" id="email" placeholder="邮箱" autocomplete="off" onblur="DetecEmail()">
