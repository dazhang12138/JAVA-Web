...
<%String path = request.getContextPath();
	...
	if(request.getAttribute("albums") == null){
		response.sendRedirect("../Albums_getAllAblums.action?path=admin/allAlbums.jsp&stat=0");
	}
%>
  ...
  <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
          ...
          <section class="progress-demo">
             <a href="<%=basePath %>Albums_getAllAblums.action?path=admin/allAlbums.jsp&stat=0" class="ladda-button" data-color="mint" data-style="expand-right" data-size="xs">刷新列表</a>
