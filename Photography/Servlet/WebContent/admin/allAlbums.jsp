...
<%String path = request.getContextPath();
	...
	if(request.getAttribute("albums") == null){
		request.getRequestDispatcher("../AllAblums?path=admin/allAlbums.jsp&stat=0").forward(request, response);
	}
%>
        ...
        <div class="container-fluid paper-wrap bevel tlbr">
          ...
          <!--   / TITLEBREADCRUMB -->
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">所有专辑</a>
                </li>
                <li class="pull-right">
          ...
          <section class="progress-demo">
             <a href="<%=basePath %>AllAblums?path=admin/allAlbums.jsp&stat=0" class="ladda-button" data-color="mint" data-style="expand-right" data-size="xs">刷新列表</a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="nest" id="tableStaticClose">
                            <div class="title-alt">
                                <h6>所有专辑列表 : <span style="color: red;">${result }</span></h6>
                                    ...
                                    <table class="table table-bordered table-striped cf" id="devCompanyInfos">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="numeric">
                                                <a type="button" class="btn btn-default" href="<%=basePath %>AlterAlbums?id=${a.a_id}">
