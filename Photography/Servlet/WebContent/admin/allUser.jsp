        ...
        <div class="container-fluid paper-wrap bevel tlbr">
          ...
          <!--   / TITLEBREADCRUMB -->
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">所有用户</a>
                </li>
                <li class="pull-right">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="nest" id="tableStaticClose">
                            <div class="title-alt">
                                <h6>所有用户列表 : <span style="color: red;">${result }</span></h6>
                                    ...
                                    <table class="table table-bordered table-striped cf" id="devCompanyInfos">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="numeric">
                                                <a type="button" class="btn btn-info"  href="<%=basePath %>DeleteUser?uid=${u.u_id }"  onclick="return confirm('是否删除 : '+'${u.u_uname }'+' 用户\n这将会删除用户下所有关联，请三思。')" >
