    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">修改专辑</a>
                </li>
                <li class="pull-right">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="nest" id="basicClose">
                            <div class="title-alt">
                                <h6>专辑信息修改 :<span style="color: red;">${result }</span></h6>
                            ...
                            <div class="body-nest" id="element">
                                <div class="panel-body">
                                      <form action="<%= basePath%>UpdateAlbums" method="get" class="form-horizontal bucket-form">
										<div class="form-group">
                                            <label class="col-sm-3 control-label">名称</label>
                                            <div class="col-sm-6">
                                            	<input type="hidden" name="id" value="${album.a_id}">
                                                <input name="name" type="text" value="${album.a_name }" id="focusedInput" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
