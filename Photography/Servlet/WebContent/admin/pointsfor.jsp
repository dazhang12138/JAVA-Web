...
<head>
    ...
    function p() {
    	...
    	var price = document.getElementById("userprice");
    	price.innerHTML = money*100;
	}
    </script>
</head>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">积分兑换</a>
                </li>
                <li class="pull-right">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="nest" id="Blank_PageClose">
                            <div class="title-alt">
                                <h6>积分兑换 <span style="color: red;">${result }</span> </h6>
                            ...
                            <div class="body-nest" id="Blank_Page_Content">
                           	<c:choose>
                           		...
                           		<form action="<%=basePath %>Pointsfor" method="post">
                            		<span>选择金额:</span>
                           		...
                           		<c:otherwise>
                           			<span style="color: red;font-size: 20px;">你的余额不支持最小兑换.</span>
                           		</c:otherwise>
                           	</c:choose>
	                        </div>
                        </div>
