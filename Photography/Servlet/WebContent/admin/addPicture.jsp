                        ...
                        <div class="nest" id="basicClose">
                            ...
                            <div class="body-nest" id="basic">
                                <div class="form_center">
                                    <form role="form" action="<%=basePath %>AddPicture" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">图片名称:</label>
                                        	<input name="aid" type="hidden" value="<%=request.getParameter("id") %>">
                                            <input name="name" type="text" id="exampleInputEmail1" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">图片简介</label>
                                       		<textarea name="profile"  placeholder="对这张图片的描述……" class="textarea form-control2"></textarea>
                                        </div>
                                        <div class="form-group">
