...
module.exports = {
    ...
    , getDefaultLoaders: function getDefaultLoaders(options) {
        ...
        { test: /\.js?$/, exclude: /node_modules/, loaders: ['react-hot-loader/webpack', 'babel?compact=false,presets[]=react,presets[]=es2015,presets[]=stage-0'] }, { test: /\.css$/, loader: ExtractTextPlugin.extract("style-loader", "css-loader") }, //"style-loader!css-loader"
    ...
    , getDefaultAlias: function getDefaultAlias(alias, nodeModulesPath) {
        var _defaultAlias = Object.assign({
            ...
            "antd": process.env.NODE_ENV ? path.join(nodeModulesPath, '/antd/dist/antd.min.js') : path.join(nodeModulesPath, '/antd/dist/antd.js')
