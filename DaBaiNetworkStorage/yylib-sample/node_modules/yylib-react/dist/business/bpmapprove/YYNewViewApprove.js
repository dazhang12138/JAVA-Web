...
var YYNewViewApprove = function (_React$Component) {
  _inherits(YYNewViewApprove, _React$Component);

  function YYNewViewApprove(props) {
    _classCallCheck(this, YYNewViewApprove);

    var _this2 = _possibleConstructorReturn(this, (YYNewViewApprove.__proto__ || Object.getPrototypeOf(YYNewViewApprove)).call(this, props));
  ...
  _createClass(YYNewViewApprove, [{
    ...
    value: function selectOnchange(e) {
      if (!e) {
        ...
        _this.props.dispatch((0, _bpm.bpmSingleViewapproveal)(_this.props.serUrl, _data));
      }
  ...
  return YYNewViewApprove;
}(_react2.default.Component);
//export default ViewapprovealComp;


YYNewViewApprove.propTypes = propTypes;
module.exports = (0, _reactRedux.connect)(mapStateToProps)(YYNewViewApprove);