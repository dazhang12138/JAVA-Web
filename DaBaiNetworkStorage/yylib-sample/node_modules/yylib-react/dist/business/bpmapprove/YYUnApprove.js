...
var _require2 = require('yylib-business'),
    YYBpmSubmit = _require2.YYBpmSubmit; //引入审批组件
...
var YYUnApprove = YYClass.create({
	...
	onClick: function onClick() {
		...
		var url = serUrl + "/icop-bpmcenter-web/bpm/unapprove";
...
module.exports = (0, _reactRedux.connect)(mapStateToProps)(YYUnApprove);