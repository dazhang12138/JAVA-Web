...
var CPAuditInfo = YYClass.create({
    ...
    renderBpm: function renderBpm() {
        ...
        return React.createElement(
            ...
            React.createElement(
                YYCol,
                { xs: { span: 24 }, sm: { span: 12 }, md: { span: 12 }, lg: { span: 12 } },
                React.createElement(
                    YYFormItem,
                    _extends({ label: '\u5BA1\u6279\u4EBA' }, formItemLayout),
                    React.createElement(YYInput, _extends({}, reviewerProps, { readOnly: true, disableClear: true }))
                )
            ),
            React.createElement(
                YYCol,
                ...
                React.createElement(
                    ...
                    React.createElement(YYDatePicker, _extends({}, reviewtimeProps, {
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(YYInput, _extends({}, billCodeProps, { readOnly: true, disableClear: true }))
                    )
                ),
                React.createElement(
                    YYCol,
                    ...
                    React.createElement(
                        ...
                        React.createElement(YYInput, _extends({}, billStateProps, { readOnly: true, disableClear: true, style: { display: 'none' } })),
                        React.createElement(YYInput, { value: billStateName, readOnly: true, disableClear: true })
                    )
                )
            ),
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(YYInput, _extends({}, creatorProps, { readOnly: true, disableClear: true }))
                    )
                ),
                React.createElement(
                    YYCol,
                    ...
                    React.createElement(
                        ...
                        React.createElement(YYDatePicker, _extends({}, createtimeProps, { disabled: true, format: 'yyyy-MM-dd HH:mm:ss',
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(YYInput, _extends({}, modifierProps, { readOnly: true, disableClear: true }))
                    )
                ),
                React.createElement(
                    YYCol,
                    ...
                    React.createElement(
                        ...
                        React.createElement(YYDatePicker, _extends({}, modifytimeProps, { disabled: true, format: 'yyyy-MM-dd HH:mm:ss',
                            placeholder: '', style: { width: '100%' } }))
                    )
                )
            ),
