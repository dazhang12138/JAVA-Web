...
var BlocklyWorkspace = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: "blockly-workspace " + (this.props.className ? this.props.className : "") },
      _react2.default.createElement(
        'xml',
        { style: { display: "none" }, ref: 'dummyToolbox' },
        dummyToolboxContent
      ),
      _react2.default.createElement('div', { ref: 'editorDiv', className: 'blockly-workspace-editor' })
    );
  }
});
